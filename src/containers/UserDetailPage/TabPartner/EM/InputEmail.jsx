...
const mapStateToProps = state => ({
  ...
  value: state.userDetailPage.partnerTab.inputValues.em_email,
  isError: state.userDetailPage.partnerTab.isInputError.em_email,
  errMsg: '0-9,a-z,A-Z,@,.しか使えないよ',
});

const mapDispatchToProps = dispatch => ({
  onChange: e => {
    dispatch(changeValue('em_email', e.target.value));
  },
});
