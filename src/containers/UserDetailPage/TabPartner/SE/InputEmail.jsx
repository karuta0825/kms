...
const mapStateToProps = state => ({
  ...
  value: state.userDetailPage.partnerTab.inputValues.se_email,
  isError: state.userDetailPage.partnerTab.isInputError.se_email,
  errMsg: '0-9,a-z,A-Z,@,.しか使えないよ',
});

const mapDispatchToProps = dispatch => ({
  onChange: e => {
    dispatch(changeValue('se_email', e.target.value));
  },
});
