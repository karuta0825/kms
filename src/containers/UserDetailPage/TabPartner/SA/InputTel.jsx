...
const mapStateToProps = state => ({
  ...
  value: state.userDetailPage.partnerTab.inputValues.sa_tel,
  isError: state.userDetailPage.partnerTab.isInputError.sa_tel,
  errMsg: '数字と-しか入力できません',
});

const mapDispatchToProps = dispatch => ({
  onChange: e => {
    dispatch(changeValue('sa_tel', e.target.value));
  },
});
