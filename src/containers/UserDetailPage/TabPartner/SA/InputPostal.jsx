...
const mapStateToProps = state => ({
  ...
  value: state.userDetailPage.partnerTab.inputValues.sa_postal_cd,
  isError: state.userDetailPage.partnerTab.isInputError.sa_postal_cd,
  errMsg: '数字と-しか入力できません',
});

const mapDispatchToProps = dispatch => ({
  onChange: e => {
    dispatch(changeValue('sa_postal_cd', e.target.value));
  },
});
